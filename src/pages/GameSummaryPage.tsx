...
import { Box, Text, VStack, Heading, Button, HStack, Center } from '@chakra-ui/react'
  ...
  return (
    <MotionContainer variants={ContainerVariants} initial='initial' animate='animate' exit='exit'>
      <VStack spacing={3}>
        ...
        {userWon === 'user' && (
          <Box textAlign='center' fontSize='xl'>
            <Heading color='green.500' fontSize='1.2rem' fontFamily='cursive' letterSpacing='wide'>
        ...
        {userWon === 'cpu' && (
          <Box textAlign='center' fontSize='xl'>
            <Heading color='orange.500' fontSize='1.2rem' fontFamily='cursive' letterSpacing='wide'>
              CPU is the winner
            </Heading>
          </Box>
        )}
          ...
          <Box w='100%' border='2px solid black' borderRadius='lg' p={4}>
            <VStack spacing={2}>
              ...
              <Box w='100%' d='flex' justifyContent='space-between' alignItems='center'>
                ...
                <Text>
                  {playerGameSummary.questionsCorrect}
                  {` / `}
                  {playerGameSummary.questionsPicked}
                </Text>
              </Box>
          ...
          <Box w='100%' border='2px solid black' borderRadius='lg' p={4}>
            <VStack spacing={2}>
              ...
              <Box w='100%' d='flex' justifyContent='space-between' alignItems='center'>
                ...
                <Text>
                  {cpuGameSummary.questionsCorrect}
                  {` / `}
                  {cpuGameSummary.questionsPicked}
                </Text>
              </Box>
        ...
        <HStack spacing={2}>
          <RouterLink to='/categories'>
            <Button p={6} bg='green.600'>
              Play Again?
            </Button>
          </RouterLink>
          <RouterLink to='/home'>
            <Button p={6} bg='yellow.400'>
              Return Home
            </Button>
          </RouterLink>
        </HStack>
